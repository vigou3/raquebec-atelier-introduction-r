...
% \begin{frame}
%   \frametitle{Ordre de remplissage des matrices et tableaux}

%   Matrices et tableaux remplis en faisant d'abord varier la première
%   dimension, puis la seconde, etc.
...
%       \end{picture}
%       \centering tableau 3 dimensions
%     \end{minipage}
%     \hfill
...
%       \end{picture}
%       \centering tableau 4 dimensions
%     \end{minipage}
%   \end{center}
...
%     \href{https://youtu.be/cQUjdwgTyz4}{%
%       \framebox[80mm][c]{%
%         \makebox[5mm]{\raisebox{-1pt}{\Large\faYoutubePlay}}\;%
%         {Création et indiçage des matrices et tableaux}}}
%   \end{center}
% \end{frame}
...
\begin{frame}[fragile=singleslide]
  ...
  Type de stockage facilitant grandement le traitement des données
  catégorielles.
  \begin{itemize}
